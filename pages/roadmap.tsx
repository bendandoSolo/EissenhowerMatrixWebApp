	...
	<>
		<div className='text-center p-40'>
			...
			<ul>
				...
				<li>Make the app look nice</li>
				<li>Implement loading spinner when the state is loading</li>
				<li>Add categories, time estimate, add system to customize those the options you want, add goals linking to categories perhaps</li>
				<li>Create and launch app/website</li>
