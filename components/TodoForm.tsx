...
const TodoForm = ({onSubmit, todo}:{onSubmit: (data: TodoType) => void, todo: TodoType | undefined }) => {
	...
	return (
		<form className='flex-column max-width-250' onChange={changed} onSubmit={handleSubmit(data => onSubmit(data))}>
				...
				<Button className='p-6' variant="contained" color="success" type='submit' disabled={disabled}
